...
def visualize_trajectory_2d_deadreckon(pose,path_name="Unknown",show_ori=False):
    '''
...
def visualize_trajectory_2d(pose,landmark,path_name="Trajectory",show_ori=False):
    '''
    function to visualize the trajectory in 2D
    Input:
        pose:   4*4*N matrix representing the camera pose, 
